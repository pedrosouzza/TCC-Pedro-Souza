...
p_PA_modificada = [5999848.2; 11999704; 17998362.6; 23997568.7; 29996309.6; 41992089.8; 53986400.2; 59983944; 59983912.1; 41992357.7; 23997737.5; 12000718.6; 6001530.1; 6001522.2; 12000095; 23997985.9; 41991722.2]; % Range de pressão da balança de teste (Pa)
...
for i = 1:length(p_PA_modificada)
    ...
    A0(i) = ((mr(i) * (1 - rhoa/rhomr)) * g + (sigma * C)) /((p_PA_modificada(i) + (rhof - rhoa) * g * deltah) * (1 + (alphac + alphap) * (t - tr)));
...
A0_Unica_modificada = 0.0000040297700063098; % Área Efetiva da balança teste do artigo (m²)
...
lambda_Unica_modificada = 3.999851762; % Coef. Distorção da balança teste do artigo (1/Pa)
