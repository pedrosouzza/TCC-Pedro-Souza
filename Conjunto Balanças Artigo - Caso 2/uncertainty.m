...
p_PA = [12000000; 15000000; 18000000; 21000000; 24000000; 27000000; 30000000; 33000000; 36000000; 39000000; 42000000; 45000000; 48000000; 51000000; 54000000; 57000000; 60000000]; % Range de pressão da balança de teste (Pa)
...
for i = 1:length(p_PA)
    ...
    A0(i) = ((mr * (1 - rhoa/rhomr)) * g + (sigma * C)) /((p_PA(i) + (rhof - rhoa) * g * deltah) * (1 + (alphac + alphap) * (t - tr)));
